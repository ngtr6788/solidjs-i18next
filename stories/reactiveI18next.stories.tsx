...
export const ResourcesReactiveOnAddResources = {
  render: () => {
    ...
    const handleAddResource = () => {
      batch(() => {
        i18n.addResource("en", "very-informal", "special.button", "Super epic button in English");
        i18n.addResource("fr", "very-informal", "special.button", "Super epic button in French");
      });
    }
    ...
    const enBundle = () => JSON.stringify(i18n.getResourceBundle("en", "very-informal"));
    const hasEnBundle = () => i18n.hasResourceBundle("en", "very-informal");

    const frBundle = () => JSON.stringify(i18n.getResourceBundle("fr", "very-informal"));
